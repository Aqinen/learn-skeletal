...
export default async function BoneDetailPage({ params }: PageProps) {
  ...
  try {
    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 overflow-x-hidden w-full max-w-[100vw]">
        <div className="container mx-auto px-4 py-16 max-w-none md:max-w-7xl">
          {/* Header */}
          <div className="mb-8">
            <Link 
              href="/"
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 break-words whitespace-normal">
              {currentRegion.name}
            </h1>
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="w-full overflow-x-auto overscroll-x-contain pb-2 md:overflow-x-visible" style={{ WebkitOverflowScrolling: 'touch' }}>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3" style={{ minWidth: '400px' }}>
                {allRegions.map((region) => (
                  region.id === decodedId ? (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500 transition-colors break-words whitespace-normal">
                        {region.name}
                      </p>
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-700 group-hover:text-blue-700 transition-colors break-words whitespace-normal">
                        {region.name}
                      </p>
                    </Link>
                  )
